...
http_archive(
    ...
    url = "https://github.com/coder/coder/releases/download/v2.21.3/coder_2.21.3_linux_amd64.tar.gz",
)
...
oci_pull(
    name = "actions_runner",
    digest = "sha256:e03b4550955d539604233352ba27cd095a880b906400bb9283f1ee4b061e21bb",
